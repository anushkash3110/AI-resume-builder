  ...
  return (
    <div className="min-h-screen bg-[#0F0F1A] text-white p-10">
      ...
      <div className="flex items-center gap-4 mb-10">
        <button onClick={() => setScreen("home")} className="text-gray-400 hover:text-white">
          ← Back
        </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {templates.map((template) => (
          <div key={template.name} className="bg-[#1A1A2E] p-4 rounded-xl">
            <img src={template.img} alt={template.label} className="rounded-lg mb-4 h-[200px] w-full object-cover" />
